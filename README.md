...
### React Fundamentals
- Fetching and displaying data within components  
- Navigation with React Router  
- Passing data through Outlet context to avoid prop drilling  
- Handling error pages  
- Using PropTypes for component validation  

### Testing
- Writing basic component tests  
- Understanding what to test without focusing on implementation details  
- Working through the challenges of mocking external behavior  

### Styling and Design
- Building a complete responsive design from scratch  
- Refining layouts for different screen sizes  
